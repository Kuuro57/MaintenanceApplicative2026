            ...
            while (continuer && utilisateur != null) {
                ...
                switch (choix) {
                    ...
                    case "2":
                        ...
                        calendar.ajouterEvent(new RdvPersonnel(
                                new Titre(titre),
                                new Personne(utilisateur),
                                new DateEvenement(jourRdv, moisRdv, annee, new HeureDebut(heure, minute)),
                                new Duree(duree)
                        ));
                    ...
                    case "3":
                        ...
                        ArrayList<Personne> participants = new ArrayList<>(List.of(new Personne(utilisateur)));
                        
                        boolean encore = true;
                        System.out.println("Ajouter un participant ? (oui / non)");
                        while (scanner.nextLine().equals("oui"))
                        {
                            System.out.print("Participants : " + participants.stream()
                                    .map(Personne::getNom)
                                    .reduce("", (acc, p) -> acc + ", " + p));
                        ...
                        calendar.ajouterEvent(new Reunion(
                                new Titre(titre2),
                                new Personne(utilisateur),
                                new DateEvenement(jourRdv2, moisRdv2, annee2, new HeureDebut(heure2, minute2)),
                                new Duree(duree2),
                                new Lieu(lieu),
                                participants
                        ));
